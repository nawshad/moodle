...
public function notification($message, $classes = 'notifyproblem') {
    ...
    protected function render_custom_menu(custom_menu $menu) {
        ...
        //$content.='<li class=""><a class="homeiconlink" href="http://www.reca.ab.ca"><div class="homeicon"><img alt="'.get_string('home').'" title="'.get_string('home').'" src="'.$CFG->wwwroot.'/theme/reca/pix/home_icon.png"></div></a></li>';
        $content.='<li class="home_item">Home</li>';
